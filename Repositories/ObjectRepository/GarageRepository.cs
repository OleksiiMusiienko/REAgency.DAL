...
namespace REAgency.DAL.Repositories.ObjectRepository
{
    public class GarageRepository: IRepositoryObject<Garage>
    {
        ...
        {
            var garages = await db.Garages.Include(o => o.estateObject).Include(c => c.estateObject.Client).
                ...
                Include(s => s.estateObject.Location.District).Include(l => l.estateObject.Location).Where(a => a.estateObjectId == id).ToListAsync();
